          ...
          <div class="card-body">
            <form method="POST" action="{{ route('drills.update', $drill->id) }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $drill->title }}"
              ...
              @for($i = 1; $i <= 10; $i++)
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <input id="problem{{ $i - 1 }}" type="text" class="form-control @error('promlem'.($i - 1)) is-invalid @enderror" name="problem{{ $i - 1 }}"
                  value="{{ $drill['problem'.($i - 1)] }}" autocomplete="problem{{  $i - 1 }}" autofocus>
